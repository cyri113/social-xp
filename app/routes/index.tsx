    ...
    <>
      ...
      <div class="p-4 mx-auto max-w-screen-md mt-16">
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-gray-500'>SocialXP is currently under construction 🏗️. Join our <a class={'hover:underline text-blue-600 font-semibold'} href='https://t.me/+OUQ9MU8YpJ02ZDY8'>Telegram Group</a> if you have questions.</p>
